...
@section('content')
        ...
        <div class="max-w-8xl mx-auto space-y-8">
            ...
            <div class="flex items-center justify-between p-6 bg-white shadow-lg rounded-2xl">
                <h2 class="text-2xl font-semibold text-pink-600">
                    <i class="fa-solid fa-box mr-2"></i>Category
                </h2>
                <button
            ...
            <div class="overflow-x-auto bg-white p-6 shadow-lg rounded-2xl">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <form id="perPageForm" method="GET" action="{{ route('admin.category.index') }}">
                    ...
                    <tbody class="text-gray-700">
                        @forelse ($categories as $category)
                            <tr class="border-b hover:bg-pink-50">
                                ...
                                <td class="py-3 px-4 whitespace-nowrap">{{ $category->nama_kategori }}</td>
                                <td class="py-3 px-4 whitespace-nowrap">{{ $category->updated_at->format('d-m-Y') }}</td>
                                <td class="py-3 px-4 space-x-2 whitespace-nowrap">
                                    <button
                                        onclick="openEditModal({{ $category->id }}, '{{ $category->nama_kategori }}', '{{ asset('storage/' . $category->gambar) }}')"
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center pt-10 text-gray-500 italic">No categories found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <!-- Modal Tambah -->
    <div id="modal-add-category" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label
                                ...
                                <input id="addGambarInput" type="file" name="gambar" class="opacity-0 absolute" accept="image/*"
    ...
    <div id="modal-delete-category"
        ...
        <div class="bg-white p-6 rounded-xl w-full max-w-sm space-y-4 shadow-xl animate-fade-in text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-800">Hapus Kategori?</h3>
            <p class="text-sm text-gray-600">Apakah kamu yakin ingin menghapus kategori ini? Tindakan ini tidak dapat
                dibatalkan.</p>
    ...
    <script>
        ...
        function openEditModal(id, namaKategori, gambarUrl) {
